...
!(function(e, t) {
    ...
    var a,
        ...
        l = new WeakMap()
    function f(e, t, n) {
        var o = l.get(e.element) || {}
        t in o || (o[t] = []), o[t].push(n), l.set(e.element, o)
    }
    function d(e, t) {
    ...
    function h(e, t, n) {
        var o = l.get(e.element) || {}
        if (!o[t]) return !0
        if (!n) return (o[t] = []), l.set(e.element, o), !0
        var r = o[t].indexOf(n)
        return (
            -1 !== r && o[t].splice(r, 1),
            l.set(e.element, o),
                ...
                (t = [
                    ...
                    },
                    {
                        ...
                        value: function(e, t) {
                            ...
                            0 === d(this, 'event:'.concat(e)).length &&
